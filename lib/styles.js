...
// Print
Styles.prototype.print = function(text, options){
    this.options.stdout.write(this.raw(text, options));
    return this;
  }
...
Styles.prototype.raw = function(text, options){
    var raw = '';
    options = options || {};
